...
// ==============================================================
#ifndef __lenet_mul_mul_11nbUr__HH__
#define __lenet_mul_mul_11nbUr__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet_mul_mul_11nbUr) {
    ...
    SC_CTOR(lenet_mul_mul_11nbUr):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
