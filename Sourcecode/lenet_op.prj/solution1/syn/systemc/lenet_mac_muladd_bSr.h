...
// ==============================================================
#ifndef __lenet_mac_muladd_bSr__HH__
#define __lenet_mac_muladd_bSr__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet_mac_muladd_bSr) {
    ...
    SC_CTOR(lenet_mac_muladd_bSr):  simcore_mac_2_U ("simcore_mac_2_U") {
