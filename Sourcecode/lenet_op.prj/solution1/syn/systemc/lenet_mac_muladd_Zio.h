...
// ==============================================================
#ifndef __lenet_mac_muladd_Zio__HH__
#define __lenet_mac_muladd_Zio__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(lenet_mac_muladd_Zio) {
    ...
    SC_CTOR(lenet_mac_muladd_Zio):  simcore_mac_0_U ("simcore_mac_0_U") {
